        ...
        <tr>
            <td>
                ...
                <input
                        ...
                        value="<?php _e('Downgrade to Legacy Kadence Memberships?', 'restrict-content'); ?>"
                />
            </td>
        </tr>
        <tr>
            <td>
                <?php _e('After downgrading, you will lose access to most of the features in Kadence Memberships 3, including membership levels and collecting payments. Additionally, content restrictions made in Kadence Memberships 3 will be lost after downgrading. Learn More', 'restrict-content'); ?>
            </td>
        </tr>
    </table>
    <?php
...
{
    ?>
    <p><?php _e("Note: The Kadence Memberships Stripe payment gateway integration includes an additional 2% processing fee. You can remove the processing fee by upgrading to Kadence Memberships Pro.", "restrict-content") ?></p>
    <?php
}
            ...
            <th id="rcp_stripe_marketing_container" class="rcp_stripe_help_box" colspan=2 style="display: none;">
                <div id="rcp_stripe_marketing_container_inner_container" class="rcp_stripe_help_box_inner_container">
                    <div class="rcp_stripe_help_box_content">
                        ...
                        <p><?php _e('Enter your email to setup the Stripe payment gateway and get tips about using Kadence Memberships', 'restrict-content'); ?></p>
